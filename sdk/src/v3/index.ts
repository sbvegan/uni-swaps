...
const provider = new ethers.providers.AlchemyProvider(null, process.env.ALCHEMY_ETHEREUM_PRIVATE_KEY);
...
async function main() {
    ...
    const TokenB = new Token(3, immutables.token0, 6, "USDC", "USD Coin");
    ...
    console.log("route: ", uncheckedTradeExample.route);
    console.log("inputAmount: ", uncheckedTradeExample.inputAmount);
    console.log("outputAmount: ", uncheckedTradeExample.outputAmount);
    console.log("tradeType: ", uncheckedTradeExample.tradeType);
}
